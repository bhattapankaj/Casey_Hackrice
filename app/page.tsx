  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-[960px] flex-col gap-12 px-5 py-10">
      <header className="max-w-[36rem]">
        ...
        <h1 className="mt-2 font-serif text-[24px] font-semibold leading-tight text-cream">
          ArtifactCard and Pip
        </h1>
        <p className="mt-3 max-w-[36rem] text-[16px] leading-relaxed text-cream/90">
          Chrome only. No artifact interiors yet. Compare the card
          geometry to the Casey logo, then tab through the buttons
          to check the gold focus ring.
        </p>
      </header>
